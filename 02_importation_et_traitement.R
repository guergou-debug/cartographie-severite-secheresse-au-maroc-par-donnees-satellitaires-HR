# =========================================================================
# ÉTAPE 1 : IMPORTATION DES RASTERS ET EXTRACTION DES STATISTIQUES ZONALES
# =========================================================================
...
for (i in 1:length(liste_fichiers)) {
  ...
  # Nom de ta colonne de noms des régions
...
# 4. Sauvegarde finale du dataset final
